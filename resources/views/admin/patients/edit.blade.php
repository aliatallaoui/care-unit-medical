...
<div class="row mt   col-lg-12">
    ...
    <div class="col-lg-8 text-center">
        ...
        <div class="form-panel">
            {!! Form::model($patient,['method'=>'DELETE','action'=>['PatientController@destroy',$patient],'class'=>'']) !!}
                <div class="form-group">
                    <h3 class="text-center "><i class="fa fa-doctor"></i> Edit Patients {!! Form::submit('Delete', ['class'=>'btn btn-danger pull-right ']) !!}</h3>
                </div>

            {!! Form::close() !!}
            <div class="form">

                {!! Form::model($patient,['method'=>'PATCH','action'=>['PatientController@update',$patient],'class'=>'cmxform
