    ...
    <div class="col-lg-8 text-center">
        ...
        <div class="form-panel">
            ...
            <div class="form">
                ...
                {!! Form::model($user,['method'=>'PATCH','action'=>['AdminUsersController@update',$user->id],'files'=>true,'class'=>'cmxform
                ...
                <div class="form-group {{ $errors->get('password') ? 'has-error' : 'has-success' }}">
                    ...
                    <div class="col-md-9">
                        <div class="fileupload fileupload-new" data-provides="fileupload">
                            <div class="fileupload-new thumbnail" style="width: 200px; height: 150px;">
                                <img src="{{ $user->photo ? "../../".$user->photo->file : 'http://www.placehold.it/200x150/EFEFEF/AAAAAA&text=no+image' }}" alt="" />
                            </div>
